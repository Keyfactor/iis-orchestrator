...
namespace Keyfactor.Extensions.Orchestrator.WindowsCertStore.WinLdap
{
    public class ReEnrollment : WinCertJobTypeBase, IReenrollmentJobExtension
    {
        ...
        public string ExtensionName => "WinLdapReEnrollment";
        ...
        public JobResult ProcessJob(ReenrollmentJobConfiguration config, SubmitReenrollmentCSR submitReEnrollmentUpdate)
        {
            ...
            return myReEnrollment.PerformReEnrollment(config, submitReEnrollmentUpdate, CertStoreBindingTypeENUM.WinLdap);
        }
    }
}
